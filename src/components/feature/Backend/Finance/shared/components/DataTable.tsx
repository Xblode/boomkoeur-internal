            ...
            {columns.map((column) => (
              <th
                ...
                className={cn(
                  ...
                  column.sortable && 'cursor-pointer hover:text-zinc-600 dark:text-zinc-400 select-none',
            ...
            return (
              <tr
                ...
                className={cn(
                  ...
                  onRowClick && 'cursor-pointer hover:bg-background-tertiary/80',
                  highlightClass
                )}
                onClick={() => onRowClick && onRowClick(item)}
                onMouseEnter={() => onRowHover && onRowHover(item.id || null)}
