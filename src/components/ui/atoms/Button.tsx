...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', loading = false, disabled, children, className = '', ...props }, ref) => {
    ...
    const variantStyles = {
      primary: 'bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-100 border-0',
    ...
    const sizeStyles = {
      xs: 'h-6 text-xs px-2 py-0.5 rounded-md gap-1',
      sm: 'h-8 text-xs px-3 py-1 rounded-md gap-1.5',
